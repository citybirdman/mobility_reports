...
def get_columns(data):
    base_columns = [
        ...
        {"fieldname": "territory", "label": "Territory", "fieldtype": "Data", "width": 150},
    ]
...
def get_data():
    ...
    city_origin=stock_df.pivot_table(index=['date','territory'],columns=['country_of_origin'], values='actual_qty', aggfunc='sum',fill_value=0).reset_index()
    ...
    return city_origin_percentage.to_dict(orient='records')
